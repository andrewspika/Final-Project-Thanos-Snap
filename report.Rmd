...
Might no longer need the code below
 |
 V
...
```{r}
# Render Plots to Summarize Information
population <- simulate.generations()

population %>% ggplot(aes(Allele)) + geom_col(position = "dodge") + facet_wrap(vars(Gen))
```
